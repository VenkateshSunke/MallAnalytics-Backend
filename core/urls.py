...
urlpatterns = [
    ...
    path("stores/<str:store_code>/", views.StoreDetailView.as_view()),
    ...
    path('steps/<int:step_id>/images/', views.CampaignStepImageView.as_view(), name='campaign-step-images'),
    path('steps/<int:step_id>/images/<int:image_id>/', views.CampaignStepImageView.as_view(), name='campaign-step-image-delete'),
