...
MALL1_PELCO_VIDEO_API_HOST = config('MALL1_PELCO_VIDEO_API_HOST')
MALL1_PELCO_VIDEO_API_USER = config('MALL1_PELCO_VIDEO_API_USER')
MALL1_PELCO_VIDEO_API_PASSWORD = config('MALL1_PELCO_VIDEO_API_PASSWORD')